<template>
	<view class="container">
		<view style="background-color: #eef3f7; padding:40px 20px;">
			...
			<u--text text="开源物联网平台 Version1.3.1" size="14" type="info" customStyle="margin:auto; margin-top:20px;"></u--text>
		...
		<view style="margin-top:20px;">
			...
			<u-cell title="作者企鹅: 164770707" size="large">
				<u-icon slot="icon" size="20" name="qq-circle-fill" color="#2ecc71"></u-icon>
		...
		<view style="position:fixed;bottom:20px;left:0;right:0;">
			<u--text size="10" type="info" align="center" text="Copyright © 2022-2023 FastBee All Rights Reserved."></u--text>
		</view>
	</view>
</template>
