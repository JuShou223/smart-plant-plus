		...
		<view style="display:flex;margin-top:20px;justify-content:flex-start;">
			<view style="margin-right:50px;">
				<u--text prefixIcon="account" iconStyle="color:#606266;font-size:14px;margin-right:3px;" size="12"
					color="#606266" mode="name" :text="trendObject.createBy"></u--text>
			</view>
			<view>
				<u--text prefixIcon="calendar" iconStyle="color:#606266;font-size:14px;margin-right:3px;" size="12"
					color="#606266" mode="date" :text="trendObject.createTime"></u--text>
			</view>
		</view>

		<u-line margin="5px 0 10px 0"></u-line>
		<view class="content"><rich-text :nodes="trendObject.noticeContent"></rich-text></view>
